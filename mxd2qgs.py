...
qgis.setAttribute("version", "2.0.1-Dufour")
...
description2 = doc.createTextNode(str(df.spatialRefernece.name))
...
def map_canvas():
	...
	ellipsoidacronym = doc.createElement("projectionacronym")
	spatialrefsys.appendChild(projectionacronym)
...
def project_layers():
	...
	# Create the <project layers> element
	...
	for lyr in lyrlist:
		...
		if(lyr.isGroupLayer == False and lyr.isRasterLayer == False):
			...
			fillcolor = foc.createElement("fillcolor")
